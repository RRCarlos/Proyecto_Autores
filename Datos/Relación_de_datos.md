...
## 2. Ranking de frecuencia de autores

### 2.1 Clasificación completa

| Pos. | Autor | Apariciones | % del total | Libros | Categoría |
|------|-------|-------------|-------------|--------|-----------|
| 1 | Plinio | 20 | 10,0 % | I, II, III, IV | Geógrafo/enciclopedista |
| 2 | Claudio Ptolomeo | 14 | 7,0 % | I, II, III, IV | Geógrafo |
| 3 | Marco Varrón | 11 | 5,5 % | I, II, III, IV | Erudito/gramático |
| 4 | Dion Casio | 8 | 4,0 % | III, IV | Historiador |
| 5 | Plutarco | 8 | 4,0 % | I, II, III, IV | Biógrafo/moralista |
...
| 19 | Cayo Suetonio Tranquilo | 3 | 1,5 % | I, IV | Biógrafo |
| 20 | Diodoro Sículo | 3 | 1,5 % | I | Historiador |
| 21 | Eusebio Cesariense | 3 | 1,5 % | IV | Eclesiástico |
...
| Capítulo | Libro | Citas | Autores citados |
|----------|-------|-------|-----------------|
| Cap XXII | I | 4 | Plinio, Arriano, Ptolomeo, Solino |
| Cap XV | I | 5 | Aristóteles, Platón, Heródoto, Solino, Plinio |
| Cap XII | I | 5 | Diodoro, Varrón, Virgilio, Isidoro, Solino |
| Cap VII | I | 4 | Ptolomeo, Estrabón, Plinio, Apiano |
| Cap VII | II | 2 | Ptolomeo, Tito Livio |
| Cap XVII | III | 5 | Varrón (×4), Lucano |
| Cap XVIII | III | 5 | Varrón (×4), Ptolomeo |
| Cap XXV | III | 6 | Ptolomeo (×2), Moro Rasis, Dion, Mela, Plinio |
| Cap XXIIII | III | 5 | Cicerón, Dion (×2), Isidoro (×3) |
| Cap XIII | IV | 4 | Ptolomeo (×2), Tito Livio, Braulio |
| Cap XVI | IV | 5 | Eusebio (×3), Moro Rasis, San Basilio |
| Cap XIX | IV | 6 | Amiano (×2), Procopio, Eusebio Capadocia (×2), San Basilio |
| Cap XX | IV | 7 | Prudencio, Quintiliano, Moro Rasis, Crinito, Isidoro, Claudiano, Orosio, Prospero |
| Cap XXV | IV (LIII) | 6 | Ptolomeo (×2), Moro Rasis, Dion, Mela, Plinio |

### 3.3 Capítulos sin citas a autores

De los 92 capítulos totales, **10 no tienen entrada alguna** en la tabla de autores. Son capítulos cuya narrativa se apoya exclusivamente en la tradición manuscrita o en la autoridad de Mariana sin citas explícitas a fuentes con nombre:

| Capítulo | Libro | Tema |
|----------|-------|------|
| Cap I | II | Hannón y sus hermanos vuelven |
| Cap IV | II | Lo que hizo Hannon |
| Cap VIII | II | Lo que Asdrúbal hizo |
| Cap IX | II | Guerra Saguntina |
| Cap XI | II | Aníbal pasa a Italia |
| Cap III | II | Guerra de Sicilia |
| Cap XIIII | II | Publio Scipión en España |
| Cap XV | II | Asdrúbal no pudo entrar en Italia |
| Cap XVII | II | Nueva guerra en África |
| Cap VIII | III | Mancio entregado a los numantinos |

**Patrón:** El Libro Segundo tiene 8 de los 10 capítulos vacíos. Su narrativa de las guerras púnicas fluye con menos aparatos eruditos.

---

## 4. Autores transculturales (presentes en múltiples libros)

### 4.1 Distribución por amplitud

| Libros citados | Autores | % | Autores |
|----------------|---------|---|---------|
| 4 libros | 5 | 7,0 % | Plinio, Ptolomeo, Varrón, Plutarco, Orosio* |
| 3 libros | 7 | 9,9 % | Cicerón, Isidoro, Tito Livio, Estrabón, Arriano, Aristóteles, Moro Rasis |
| 2 libros | 20 | 28,2 % | Dion, Séneca, Apiano, Silio, Polibio, Prudencio, Suetonio, Eusebio(s), Lucano, Mela, Crinito, Amiano, etc. |
| 1 libro | 37 | 52,1 % | Los demás |

*Orosio aparece en II, III y IV.

### 4.2 Los 5 «pilares» de Mariana (citados en los 4 libros)

| Autor | L | LII | LIII | LIV | Total | Rol en la obra |
|-------|---|-----|------|-----|-------|----------------|
...
| **Varrón** | 1 | 3 | 7 | 0 | 11 | Erudición lingüística y militar |
| **Plutarco** | 1 | 2 | 3 | 2 | 8 | Biografías, etimología, costumbres |
| **Orosio** | 0 | 1 | 1 | 1 | 3 | Cronología universal cristiana |

**Nota:** Varrón tiene 0 citas en LIV (su utilidad se agota con la llegada del mundo cristiano). En cambio, Plutarco y Plinio se mantienen transversales.
...
| IV | 22 | Prudencio, Quintiliano, Amiano, Procopio, San Basilio, Claudiano, San Jerónimo, Trebellio Polión |

El Libro Cuarto concentra **22 autores exclusivos**, reflejando la explosión de fuentes eclesiásticas y tardorromanas que Mariana necesita para los siglos I–V.
...
| Línea | Libro | Autores simultáneos | Contexto |
|-------|-------|---------------------|----------|
| 687 | I | Plinio + Estrabón + Ptolomeo | Tres autoridades geográficas sobre pueblos hispanos |
| 96 | II | Dionisio + Tito Livio + Tucides | Cicerón cita tres sobre la peste antigua |
| 1365 | I | Varrón + Plutarco | Origen del nombre «España» |
| 1482 | I | Estrabón + Solino | Ulises llegó a España |
| 1885 | I | Plinio + Solino | Fundación de Tarragona |
| 2155 | I | Tito Livio + Polibio | Etnónimos Turdulos/Turdetanos |
| 145 | IV | Dion + Tacito + Plinio | El ave fénix — tres autoridades |
| 310 | IV | Séneca + Lucano | Nerón mata a su maestro y al poeta |
| 339 | IV | Beda + Usuardo | Cronología apostólica |
| 2799 | III | Ptolomeo + Mela | Aras Sextianas de Augusto |
| 2481 | III | Cicerón + Lucilio | Etimología del término «Era» |
| 3160 | IV | Orosio + Prospero | Discrepancia de dos años en cronología |
...
## 6. Tipología de fuentes

### 6.1 Clasificación por disciplina

| Categoría | Autores | Apariciones | % |
|-----------|---------|-------------|---|
| **Historiadores** | 15 | 55 | 27,4 % |
| **Geógrafos/cosmógrafos** | 4 | 41 | 20,4 % |
| **Filósofos/oradores** | 4 | 21 | 10,4 % |
| **Poetas/literatos** | 6 | 17 | 8,5 % |
| **Eclesiásticos/padres de la Iglesia** | 15 | 28 | 13,9 % |
| **Biógrafos/moralistas** | 3 | 16 | 8,0 % |
| **Compiladores/eruditos** | 5 | 20 | 10,0 % |
| **Retóricos/gramáticos** | 3 | 9 | 4,5 % |
| **Comentaristas medievales/renacentistas** | 7 | 8 | 4,0 % |
| **Fuentes fabulosas/espurias** | 3 | 3 | 1,5 % |
...
**Eclesiásticos (28):** San Isidoro (7), Eusebio Cesariense (3), Eusebio Capadocia (2), San Basilio (2), Eusebio Nicomedia (1), Eusebio Vercelli (1), Braulio (1), San Lucas (2), San Gregorio Nacianceno (1), Beda (1), Pelayo (1), Nicéforo (1), Prospero (1), Usuardo (1), Prudencio (6) — *cruza con poetas*.

**Compiladores/eruditos (20):** Varrón (11), Solino (3), Suetonio (3), Plutarco (8) — *cruza con biógrafos*.

### 6.3 Proporción pagano vs. cristiano

| Tipo | Autores | Apariciones | % |
|------|---------|-------------|---|
| Autores paganos/clásicos | 52 | 155 | 77,1 % |
| Autores cristianos/eclesiásticos | 16 | 35 | 17,4 % |
| Autores mixtos/ambiguos | 3 | 11 | 5,5 % |

**Interpretación:** Mariana es un jesuita del siglo XVI, pero su aparato erudito es **preponderantemente clásico-pagano** (77 %). Las fuentes cristianas (37 % de los autores pero solo 17 % de las citas) se concentran casi exclusivamente en el Libro Cuarto, donde la historia de la Iglesia lo exige. Esto es coherente con el método historiográfico de la Compañía de Jesús: rigor documental clásico al servicio de una narrativa cristiana.

---

## 7. Mapa cronológico de las fuentes

### 7.1 Por época de composición

| Época | Período | Autores | Apariciones | % |
|-------|---------|---------|-------------|---|
| **Arcaico/clásico griego** | s. V–III a.C. | Heródoto, Tucides, Aristóteles, Platón, Filón | 9 | 4,5 % |
| **Helenístico** | s. III–I a.C. | Polibio, Diodoro, Eratóstenes* | 7 | 3,5 % |
| **República romana** | s. III–I a.C. | Tito Livio, Varrón, Cicerón, Fabio Pictor, Valerio Sorano | 27 | 13,4 % |
| **Imperio romano alto** | s. I–II d.C. | Plinio, Ptolomeo, Estrabón, Séneca, Plutarco, Dion, Silio, Lucano, Ovidio, Tácito, Justino, Orosio, Tertuliano | 87 | 43,3 % |
| **Imperio romano tardío** | s. III–V d.C. | Arriano, Amiano, Prudencio, Claudiano, Eusebio(s), San Basilio, Gregorio Nacianceno, Severo Sulpicio, Prospero | 25 | 12,4 % |
| **Alta Edad Media** | s. VI–X | San Isidoro, Braulio, Beda, Pelayo | 16 | 8,0 % |
| **Plena Edad Media** | s. XI–XIII | Moro Rasis, Usuardo, Sigiberto, Nicéforo | 6 | 3,0 % |
| **Renacimiento** | s. XIV–XVI | Poggio, Crinito, Giraldo, Nebrija, Andrea de' Bardi, Ambrosio de Morales | 8 | 4,0 % |
| **Fuentes espurias** | Varios | Falso Beroso, Festo Pompeyo | 2 | 1,0 % |

*Eratóstenes no aparece en la tabla; incluido como referencia contextual.

**Pico máximo:** El Imperio romano alto (siglos I–II d.C.) aporta el **43,3 %** de todas las citas con solo el 18,3 % de los autores. Es la «edad de oro» de las fuentes de Mariana: Plinio, Ptolomeo, Séneca, Plutarco, Dion y Estrabón forman el núcleo irrompible.

### 7.2 Antigüedad relativa de las fuentes

| Antigüedad de la fuente | Citas | % |
|--------------------------|-------|---|
| Más antiguas que la obra de Mariana (>1400 años) | 96 | 47,8 % |
| Entre 800–1400 años antes | 31 | 15,4 % |
| Entre 400–800 años antes | 38 | 18,9 % |
| Entre 100–400 años antes | 30 | 14,9 % |
| Casi contemporáneos (<100 años) | 6 | 3,0 % |
...
Mariano no es un compilador pasivo. Al menos **12 citas** incluyen juicio explícito del autor:
...
## 9. Corrupción OCR y variantes textuales

### 9.1 Autores con mayor corrupción en el OCR

| Autor | Variantes OCR detectadas | Corrupción |
|-------|--------------------------|------------|
| Plinio | "Plinio", "Plinió", "PlicniijTaqualfucvifta" | Alta en LIV (L145) |
| Estrabón | "Eftrabon", "Eftrabpn" | Media |
| Plutarco | "Plutarcho", "Plutarcho" (sin corrupción grave) | Baja |
| Tito Livio | "Tito Liuio" (siempre) | Media-consistente |
| Polibio | "Polybio", "Poybio" | Media |
| Séneca | "Seneca" (sin corrupción) | Baja |
| Cicerón | "Cicerón", "Ciceron" (sin acento) | Baja |
| Ptolomeo | "Ptolomeo" (consistente) | Baja |
| Moro Rasis | "Moro Rafis", "Rafis" | Media |
| Beda y Usuardo | "Beda y Vfuardo" | Alta (Usuardo → Vfuardo) |
| Severo Sulpicio | "Señero Sulpicio" (LIV L2870) | Alta |
| Julio Capitolino | "Iulio Capitolino" | Baja (grafía latina) |
...
|--------|---------|-------------|---------------------|
| Italia / Roma | ~24 | 33,8 % | Plinio, Varrón, Livio, Cicerón, Virgilio, Ovidio |
| Grecia / Asia Menor | ~18 | 25,4 % | Ptolomeo, Dion, Plutarco, Strabón, Apiano, Pausanias |
| Hispania | ~8 | 11,3 % | Séneca, Floro, Columela, Pacato, Lucano, Prudencio |
| Norte de África | ~4 | 5,6 % | Apuleyo (Numidia), Sulpicio (Gaul), Tertuliano (Cartago) |
| Siria / Oriente Próximo | ~3 | 4,2 % | Filón de Biblos, Orígenes, Josefo |
...
|--------|---------|---|------------------------|
| Latín | ~35 | 49,3 % | Plinio, Varrón, Livio, Cicerón, Séneca, Beda, Columela |
| Griego | ~20 | 28,2 % | Ptolomeo, Dion, Platón, Aristóteles, Plutarco, Strabón |
| Griego traducido al latín | ~6 | 8,5 % | Ptolomeo (Traducción de Giorgio Valla), Dion Casio |
| Árabe | ~2 | 2,8 % | Moro Rasis, Alboácen |
...
Homero → (oral) → Heródoto → Plutarco → Mariana
                 → Pausanias → Mariana
                 → Strabón → Mariana
Tucídides → Dion Casio → Mariana
           → Apiano → Mariana
Platón → Aristóteles → (retransmisiones diversas) → Mariana
Polibio → Livio → Floro → Mariana
        → Plutarco → Mariana
Suetonio → Dion Casio → Mariana
         → Aurelio Víctor → Mariana
Varrón → Columela → Mariana (fuentes agronómicas)
      → Festo Pompeyo → Mariana
      → Nonio Marcelo → Mariana
Plinio el Viejo → Ptolomeo → Mariana
               → Columela → Mariana
               → Solino → Mariana
```
...
- **Floro** (5 citas) funciona como **abreviador de Livio**: Mariana cita a Floro en lugar de a Livio directamente en varias ocasiones, lo que sugiere que tenía más acceso a Floro.
...
|------------------|-------------------|------------|
| Filón de Biblos | *Fenicia* | Perdida; conocida por citas de Josefo y Eusebio |
