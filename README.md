...
El objeto de estudio son **180 citas distribuidas en los Libros I–IV**, referenciadas contra la edición de 1601 y clasificadas según su función en el argumento de Mariana.
...
└── Ediciones_HGE/
    ...
    ├── 01_libro_primero.txt           — Libro I
    ├── 02_libro_segundo.txt           — Libro II
    ├── 03_libro_tercero.txt           — Libro III
    └── 04_libro_cuarto.txt            — Libro IV
```
