...
El objeto de estudio son **181 citas distribuidas en los Libros I–IV**, referenciadas contra la edición de 1601 y clasificadas según su función en el argumento de Mariana.
...
Se realizó una verificación exhaustiva de las **181 citas** contra los archivos OCR de la edición de 1601. Resultados:

- **Autores verificados como fuentes citadas**: 60 de los 68 autores iniciales resultaron ser citaciones genuinas
...
Se incluyen además:
- **Resumen por autor** (60 autores con temática y frecuencia de aparición)
...
│
├── Tablas/
│   ├── Tabla de autores 1.md          — Tabla principal: 181 citas con Cita y Contexto
