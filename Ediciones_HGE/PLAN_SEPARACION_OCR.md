...
## Fase 2: Extraer el OCR de los Libros I–IV ◀ EN CURSO

> **Inicio pendiente.** Se trabaja directamente con el PDF. El archivo `mariana_1617_tomo_primero_ocr.txt` se trata como si no existiera en esta fase.
